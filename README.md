...
StratusClaw is a tiny JavaScript agent kernel. This workspace currently contains only the core package and the minimum scaffolding needed to validate the architecture.
