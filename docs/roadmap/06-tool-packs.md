...
- A page redirecting `browser.goto`/`browser.read` to `http://169.254.169.254/` or the localhost gateway is blocked at the request level, not just at invocation approval (tested).
