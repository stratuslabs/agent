 ...
 *
 * Every package name reaching the shell is a constant in its caller — the
 * optional packages `setup` offers, this package's own name in `update` —
 * so there is nothing user-supplied here for it to re-parse.
 */
